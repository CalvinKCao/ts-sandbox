#!/bin/bash
# Fourier conditioning + flatline-blur fine target on Killarney (L40S).
#
# USAGE (Killarney login node, from $SCRATCH/ts-sandbox):
#   ./submit_fourier_flatline_blur_killarney.sh --smoke-test
#   ./submit_fourier_flatline_blur_killarney.sh
#   ./submit_fourier_flatline_blur_killarney.sh --datasets ETTh1,exchange_rate,weather
#
set -euo pipefail
