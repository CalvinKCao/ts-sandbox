...
#   git pull
#   ./temp/submit_binary_mmpd_diag_lb336_hz720_aug_fixed20_killarney.sh --smoke-test
#   ./temp/submit_binary_mmpd_diag_lb336_hz720_aug_fixed20_killarney.sh
#   ./temp/submit_binary_mmpd_diag_lb336_hz720_aug_fixed20_killarney.sh --test-fraction 0.125
#
set -euo pipefail
