...
#   ./temp/submit_ablate_sample_diversity_a1_a5_killarney.sh
#   ./temp/submit_ablate_sample_diversity_a1_a5_killarney.sh --smoke-test
# =============================================================================
...
elif [[ -n "${SLURM_SUBMIT_DIR:-}" && -f "$SLURM_SUBMIT_DIR/temp/ablate_sample_diversity_a1_a5.py" ]]; then
    REPO="$SLURM_SUBMIT_DIR"
else
    REPO="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
fi
SCRIPT_DIR="$REPO/temp"
PY_SCRIPT="temp/ablate_sample_diversity_a1_a5.py"
