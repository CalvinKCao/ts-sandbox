...
#   git pull
#   ./temp/submit_isolate_past_native_regression_killarney.sh ablations electricity
#   ./temp/submit_isolate_past_native_regression_killarney.sh eval-replay traffic
#   ./temp/submit_isolate_past_native_regression_killarney.sh fresh-guidance electricity
#   ./temp/submit_isolate_past_native_regression_killarney.sh compare electricity
#
