...
#   ./temp/scripts/submit_discriminator_binary_vs_mmpd_univariate_fair_killarney.sh --smoke-test
#   ./temp/scripts/submit_discriminator_binary_vs_mmpd_univariate_fair_killarney.sh
#
set -euo pipefail
