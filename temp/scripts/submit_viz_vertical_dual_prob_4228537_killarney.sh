...
#   ./temp/scripts/submit_viz_vertical_dual_prob_4228537_killarney.sh
#   ./temp/scripts/submit_viz_vertical_dual_prob_4228537_killarney.sh --n-windows 4 --n-samples 8 --steps 20
# =============================================================================
...
elif [[ -n "${SLURM_SUBMIT_DIR:-}" && -f "$SLURM_SUBMIT_DIR/temp/scripts/viz_vertical_dual_prob_samples_4228537.py" ]]; then
...
VIZ_PY="temp/scripts/viz_vertical_dual_prob_samples_4228537.py"
PY_ARGS=("$@")
