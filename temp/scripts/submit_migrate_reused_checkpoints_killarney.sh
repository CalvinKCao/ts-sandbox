...
#
# USAGE:
#   ./temp/scripts/submit_migrate_reused_checkpoints_killarney.sh \
...
#
#   ./temp/scripts/submit_migrate_mmpd_lb336_hz96_killarney.sh --apply
#
#   ./temp/scripts/submit_migrate_grid_lb336_hz720_ordinal_four_killarney.sh --apply
#
set -euo pipefail
