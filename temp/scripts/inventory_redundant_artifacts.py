...
LIVE_SCRIPTS = {
    ...
    "submit_mmpd.sh",
    "slurm_worker.sh",
    "temp/scripts/run_h96_ordinal_patch_refine_mmpd_dag.sh",
    "temp/scripts/run_pipeline_coverage_deadcode.py",
    "temp/scripts/submit_pipeline_coverage_deadcode.sh",
    "temp/scripts/inventory_redundant_artifacts.py",
    "temp/scripts/submission_manifest.py",
    "temp/scripts/eval_univariate_patch_refine_ordinal_vs_mmpd.py",
}
...
def build_report(coverage_json: Path | None) -> str:
    ...
    lines.append("")
    lines.append("Generated by `temp/scripts/inventory_redundant_artifacts.py`.")
