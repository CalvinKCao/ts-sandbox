...
Usage (from repo root, with .venv):
  python temp/scripts/ablate_sample_diversity_a1_a5.py --quick
  python temp/scripts/ablate_sample_diversity_a1_a5.py --full
  # Killarney: ./temp/scripts/submit_ablate_sample_diversity_a1_a5_killarney.sh
"""
