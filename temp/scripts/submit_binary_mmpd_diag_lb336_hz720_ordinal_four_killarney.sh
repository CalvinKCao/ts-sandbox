...
#
# Prereq: ./temp/scripts/submit_migrate_grid_lb336_hz720_ordinal_four_killarney.sh --apply
#
# USAGE (Killarney login, $SCRATCH/ts-sandbox):
#   ./temp/scripts/submit_binary_mmpd_diag_lb336_hz720_ordinal_four_killarney.sh --smoke-test
#   ./temp/scripts/submit_binary_mmpd_diag_lb336_hz720_ordinal_four_killarney.sh
#   ./temp/scripts/submit_binary_mmpd_diag_lb336_hz720_ordinal_four_killarney.sh --test-fraction 1.0
#
set -euo pipefail
