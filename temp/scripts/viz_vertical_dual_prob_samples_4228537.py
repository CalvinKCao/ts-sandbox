...
Example (Killarney / local with ckpts pulled):
  ...
  python temp/scripts/viz_vertical_dual_prob_samples_4228537.py
  python temp/scripts/viz_vertical_dual_prob_samples_4228537.py --n-windows 4 --n-samples 8 --steps 20
"""
