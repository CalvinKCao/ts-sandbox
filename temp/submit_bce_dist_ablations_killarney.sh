...
#   ./temp/submit_bce_dist_ablations_killarney.sh geo
#   ./temp/submit_bce_dist_ablations_killarney.sh fixed
#   ./temp/submit_bce_dist_ablations_killarney.sh all
#   ./temp/submit_bce_dist_ablations_killarney.sh geo --smoke-test
# =============================================================================
