...
#   ./temp/submit_discriminator_texture_lb336_hz720_ordinal_four_patch_only_fair_killarney.sh --smoke-test
#   ./temp/submit_discriminator_texture_lb336_hz720_ordinal_four_patch_only_fair_killarney.sh
#
set -euo pipefail
