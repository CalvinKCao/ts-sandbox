...
# Effective batch = probed_max × {4, 8}. (16× config exists but omitted for now.)
#
...
CONFIGS="configs/binary_anchor_ar_grad_accum_400.yaml,configs/binary_anchor_ar_grad_accum_800.yaml"
WALL_TIME="5:00:00"
