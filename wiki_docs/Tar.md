...
The primary archiving utility on all Linux and Unix-like systems is the [tar](https://www.gnu.org/software/tar/manual/tar.html) command. It will bundle a bunch of files or directories together and generate a single file, called an *archive file* or *tar-file*. By convention an archive file has <code>.tar</code> as the file name extension. 
