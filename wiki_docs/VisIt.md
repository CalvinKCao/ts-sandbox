...
[File:LauncherBasicArguments.png](File:LauncherBasicArguments.png.md)

[File:LauncherAdvancedArguments.png](File:LauncherAdvancedArguments.png.md)

Save the settings with *Options -> Save Settings* and then exit VisIt on your laptop for settings to take effect.

If your account has multifactor authentication enabled, you will need to [configure your SSH client with ControlMaster](Multifactor_authentication#Configuring_your_SSH_client_with_ControlMaster.md) and make sure to use the full host name for Host, e.g.
...
[File:SelectProfile.png](File:SelectProfile.png.md)
...
{| align="center"
| [880px|](File:Visit_trillium-01.png.md)
|}
...
<br style="clear:both" />
{| align="center"
| [400px|](File:Visit_niagara-02.png.md)
| [400px|](File:Visit_niagara-03.png.md)
|}
<br style="clear:both" />
