...
[Category:ComputationalChemistry](Category:ComputationalChemistry.md)
## General
...
wget "https://www.chemspider.com/FilesHandler.ashx?type{{=
```str&3d{{=}}yes&id{{=}}171" -O acetic_acid.mol
...
#### Example
The following job takes the [Structural Data File](https://en.wikipedia.org/wiki/Chemical_table_file#SDF) <code>many_molecules.sdf</code>,
...
The [Python interface for Open Babel](https://openbabel.org/docs/UseTheLibrary/Python.html) has been added to the both <code>openbabel</code> and <code>openbabel-omp</code> modules as extensions.
