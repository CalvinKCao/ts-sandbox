...
1. Select *I request access*.
1. Click on the button to accept each of the following agreements
...
*Large and adjustable per group [quotas](Storage_and_file_management#Quotas_et_politiques.md) 
*Daily backup
|}
...
|-
| 81 || 64 || 498G or 510000M || 1 x NVMe SSD, 3.84TB || 2 x [Intel Xeon Gold 6448Y](https://ark.intel.com/content/www/us/en/ark/products/232384/intel-xeon-gold-6448y-processor-60m-cache-2-10-ghz.html) @ 2.10 GHz, 60MB cache L3 || 4 x NVidia H100 SXM5 (80GB), connected via NVLink
|}
...
- groups of 8 closely spaced cores sharing a single L3 cache, which is ideal for [multithreaded parallel programs](Running_jobs#Threaded_or_OpenMP_job.md) (for example, with the <code>--cpus-per-task=8</code> option)
...
The maximum recommended number of <b>CPU cores and system memory</b> per GPU instance is listed in [this table](Allocations_and_compute_scheduling#Ratios_in_bundles.md).