...
|-
| Globus collection: [<i>alliancecan#fir-globus</i>](https://globus.alliancecan.ca/file-manager?origin_id=8dec4129-9ab4-451d-a45f-5b4b8471f7a3&two_pane=false)
|-
...
[thumb|900x900px|Layout of Fir CPU nodes, as reported by the <code>lstopo</code> command](File:Fircpulayout.png.md)
...
### Layout
[thumb|900x900px|Layout of Fir GPU nodes, as reported by the "lstopo" command](File:Firgpulayout.png.png.md)
