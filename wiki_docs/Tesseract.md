...
Then you need to tell Tesseract where to find the models using the environment variable <code>TESSDATA_PREFIX</code>. For example, if you save the models in <code>~/tessdata</code>, then you would use the follow command:
