...
<i>Parent page: [Storage and file management](Storage_and_file_management.md)</i>
...
Default filesystem permissions are defined by something called the [<code>umask</code>](https://en.wikipedia.org/wiki/Umask). There is a default value that is defined on any Linux system. To display the current value in your session, you can run the command
```bash
umask -S
```
...
<br />1. Send email to our [technical support](technical_support.md) requesting creation of data sharing group, indicate name of the group you would like to have and that you should be the owner.
<br />2. When you receive confirmation from the technical support team that the group has been created, go to [ccdb.computecanada.ca/services/](https://ccdb.computecanada.ca/services/) and access it:<br />
[1036px|Services screen displaying groups you can manage](File:Cc_services_screen.png.md)

<br />3. Click on the group's name and enter the group management screen:<br />
[1036px|Services screen showing group's owner](File:Cc_service_management_screen.png.md)
 
<br />4. Add member (Victor Van Doom with CCI vdv-888, for example) to the group as a member:<br />
[1036px|Services screen showing members of the group](File:Cc_service_add_member_success_screen.png.md)
