...
- The best-known tool for archiving files in the Linux community is <tt>tar</tt>.  Here is [a tutorial on 'tar'](a_tutorial_on_'tar'.md).
- A replacement for <tt>tar</tt> called <tt>dar</tt> offers some advantages in functionality.  Here is [a tutorial on 'dar'](Dar.md).  Both <tt>tar</tt> and <tt>dar</tt> can compress files as well as archive. 
