...
- A well written question (or a problem description) will likely result in a faster and more accurate assistance from our staff (see a [support request example](#Support_request_example.md) below).
- An email titled "Something is wrong" or "Nothing works" will take a long time to resolve, because we will have to ask you to provide missing information (see [Information required](#Information_required.md) below).
...
- [mailto:globus@tech.alliancecan.ca globus@tech.alliancecan.ca] -- Questions about **[Globus](Globus.md)** file transfer services
- [mailto:cloud@tech.alliancecan.ca cloud@tech.alliancecan.ca] -- Questions about using **[Cloud](Cloud.md)** resources
- [mailto:allocations@tech.alliancecan.ca allocations@tech.alliancecan.ca] -- Questions about the [Resource Allocation Competition](https://alliancecan.ca/en/services/advanced-research-computing/accessing-resources/resource-allocation-competition) (RAC)
- [mailto:trillium@tech.alliancecan.ca trillium@tech.alliancecan.ca] -- For questions or issues regarding to the [Trillium](Trillium.md) cluster specifically
...
- Avoid sending screenshots or other large image attachments except when necessary - the plain text of your commands, job script etc. is usually more helpful.  See [Copy and paste](FAQ#Copy_and_paste.md) if you have trouble with this.
