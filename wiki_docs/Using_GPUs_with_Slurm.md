...
|-
! Cluster !! GPU model 
!MIG!! Model specifiers<br>for Slurm 
!Synonyms for Slurm
|- 
...
|-
| MI300A-128gb  
| || (none; see [Nibi](Nibi#Node_characteristics.md)) 
|
|- 
...
[NVIDIA Data Center GPU Manager (DCGM)](https://developer.nvidia.com/dcgm). This must be done during job submission by setting the <code>DISABLE_DCGM</code> environment variable:

```bash
DISABLE_DCGM{{=
```1 salloc --account{{=}}def-someuser --gpus-per-node{{=}}a100:1 --mem{{=}}4000M --time{{=}}03:00}}
...
= See also =
[CUDA](CUDA.md)<br>
[Multi-Instance GPU](Multi-Instance_GPU.md)<br>
...
[Cuda Multi-Process Service (MPS)](Hyper-Q_/_MPS.md)