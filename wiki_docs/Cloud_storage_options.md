...
- <b>[Volume storage](Working_with_volumes.md)</b>: The standard storage unit for cloud computing; can be attached to and detached from an instance. 
...
- <b>[Object storage](Arbutus_object_storage.md)</b>:  Non-hierarchical storage where data is created or uploaded in whole-file form.
- <b>[Shared filesystem storage](Arbutus_CephFS.md)</b>: Private network attached storage space (similar to NFS/SMB shares); must be configured on each instance where it is mounted.
