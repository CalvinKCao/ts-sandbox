...
1. Set "tensor_parallel_size" to the number of GPUs in your job.
...
**File: vllm-multinode-example.sh**
```bash
#!/bin/bash
#SBATCH --nodes 2
...
1. Set "tensor_parallel_size" to the TOTAL number of GPUs on all nodes.
