...
1. <code>module load StdEnv/2020 vtune</code>  
1. <code>vtune-gui</code><br>

## VDI nodes

1. Connect to gra-vdi.alliancecan.ca with [TigerVNC](https://docs.alliancecan.ca/wiki/VNC#VDI_Nodes)
1. <code>module load CcEnv StdEnv/2020 vtune</code> 
1. <code>vtune-gui</code><br>
...
[thumb|center|800px|Example report generated by aps for an MPI program](File:Vtune_mpi_profiling_report.png.md)