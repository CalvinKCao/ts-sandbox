...
<includeonly> <div class="floatright"> [40px|link=https://explainshell.com/explain?cmd={{urlencode:{{{1}}} }}](File:Question.png.md) </div> <div class="command">{{#tag:syntaxhighlight|{{{prompt|[username@narval ~]$}}} {{{1}}}{{{result|}}}|lang={{{lang|bash}}}}}</div></includeonly><noinclude>
```bash
module load julia
result=
``` 
...
[thumb|alt=Résultats de 1000 simulations de l'état de Bell.](File:Bell_Graph.png.md)