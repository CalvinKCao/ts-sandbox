...
Connect to a cluster using [VNC](VNC.md), <code>ssh -X</code>, or <code>ssh -Y</code>, in order to enable graphics.  
...
See [Using modules](Using_modules.md) for more on the <code>module</code> command, including how to find and use other pre-installed versions.
