...
- [**JupyterLab via JupyterHub**: a pre-installed JupyterLab environment](JupyterHub#JupyterLab.md), with a default Python kernel and the access to software modules
- [**JupyterLab from a virtual environment**: a self-made environment](Advanced_Jupyter_configuration.md) to be launched by a Slurm job
...
- [**Jupyter Notebook via JupyterHub**: a pre-installed Jupyter Notebook environment](JupyterHub#User_Interface.md), with a default Python kernel and the access to software modules
- [**Jupyter Notebook from a virtual environment**: a self-made environment](JupyterNotebook.md) to be launched by a Slurm job
