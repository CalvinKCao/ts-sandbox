...
3. Install the [R dependencies](R#Installing_R_packages.md). It is important to install these exact versions. During installation, if you are prompted to install the latest version of any dependency, simply press Enter to decline.
