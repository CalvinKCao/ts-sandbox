...
Use <code>module load hdf/version</code> (or <code>module load hdf5/version</code>) to set your environment to use your chosen version.  For example, to load the HDF5 version 1.14.2 library do: 
