...
1. Click on the *Login* button at the top right-hand corner of the window. 
1. Click on the *Register* button at the bottom of the screen.
1. Fill out the form with the relevant information, making sure to enter a valid email address, and then click on *Next*.
1. Select your password and security questions, click on the *I'm not a robot box* and then click on the *Submit* button.
1. Follow any further instructions contained in the confirmation email and log in to the CCV website. 
...
1. In the drop-down list, select *Funding.* 
1. In the *Funding Source* field, select *Digital Research Alliance of Canada*.
1. In the *CV Type* field, select *Alliance*.
1. Click on the *Load* button at the top of the window.[none|thumb|420x420px](File:Screen_shot_2022-06-20_at_5.20.04_pm.png.md)
1. The list is displayed, which contains only the subset of CCV fields required by the Alliance.
1. Each row with a green checkmark indicates that the information provided meets Alliance’s criteria for submission.
1. Each row with a red x-mark indicates that contents is missing. Click on the pencil icon to edit the information. The CCV interface will inform you which fields are missing or filled out incorrectly.
1. To preview your CCV submission, click on the *Preview* button.
1. To begin the submission process, click on the *Submit* button.
1. Make note of the **confirmation number** you are assigned upon submission. It is mandatory to enter this number on the CCDB to link your RAC application with your CCV submission. 
...
1. Agree to the consent terms and confirm your submission.[none|thumb|451x451px](File:Updated_screen_shot_2022-06-08_at_7.34.48_am_1.png.md)
...
1. Once in the account renewals application form, scroll down to the *Canadian Common CV* section.[none|thumb|464x464px](File:Not_changed_screen_shot_2021-09-03_at_9.59.00_am.png.md)
1. Enter the submission **confirmation number** you obtained from completing your Alliance CCV. Remember that only confirmation numbers for the **Alliance template** will be accepted.
1. Click on the *Update CCV* button: 
...
1. Report contributions enabled by Alliance resources (see here for instructions).

If you have further questions about the renewals process, please visit our [Renewals FAQ](Account_renewal_FAQ.md) page. 
...
If you have further questions, please visit the [Resource Allocation Competitions](Account_renewal_FAQ.md) (RAC) page. 
...
1. Under the Resource Allocation Competitions section, go to the *Ongoing Competitions* tab and click on *Apply* in the corresponding RRG or RPP section to start a new application, or click on *Edit* to continue working on an already created application.
1. In the application form, scroll down to the *Canadian Common CV* section.
1. Enter the submission confirmation number you obtained from the steps explained in Section 3 of this document. Remember that only confirmation numbers for the Alliance template will be accepted.
1. Click on the *Submit CCV* button. 
...
#* If there is an error trying to process your submission, you will receive an error message.
#* If you are absolutely sure that your CCV submission was successful and the parameters you have entered are correct, yet you receive an error on CCDB, please contact support@tech.alliancecancomputecanada.ca for assistance.
1. Report contributions enabled by our computational resources (see instructions in **Section 6** of this document).
...
[none|thumb|478x478px](File:Not_changed_co-pi_ccv_status_en.png.md)
...
1. Under the *Ongoing Competitions* tab, navigate to the application where you are listed *As a Co-PI of*
1. Click on *Update CCV*.
1. Follow the instructions.[none|thumb|504x504px](File:Not_changed_update_ccv_button_en.png.md)
...
[none|thumb|496x496px](File:Screen_shot_2022-06-15_at_11.55.50_am.png.md)
...
1. Check the box next to each publication to clear the red border one-by-one or simply click *Select all new* to mark all of your publications as enabled by our resources.
1. Click on the *Clear all new* button if none of the new publications uploaded were enabled by our computational resources.
...
### Academic PI with an existing CCV on file 
...
1. Enter the new CCV confirmation code on CCDB and click on *Update CCV*.[none|thumb|457x457px](File:Updated_screen_shot_2022-06-10_at_9.39.40_am.png.md)
1. Once the new CCV has been successfully uploaded, you will see the list of publications included in the most recently submitted CCV, showing the CC enabled publications enabled by our computational resources as you marked them the last time you submitted your CCV.
