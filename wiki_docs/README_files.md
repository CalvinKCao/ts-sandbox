...
- <code>README.md</code> ([Markdown](https://www.markdownguide.org/)), <code>README.rst</code> ([reStructuredText](https://www.sphinx-doc.org/en/master/usage/restructuredtext/basics.html))
** Structured text format that remains human readable.
** Can be compiled into formatted text (HTML or PDF).
- <code>README.yaml</code> ([YAML](https://yaml.org)), <code>README.json</code> ([JSON](https://en.wikipedia.org/wiki/JSON)), <code>README.xml</code> ([XML](https://developer.mozilla.org/en-US/docs/Web/XML/Guides/XML_introduction))
