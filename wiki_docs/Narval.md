...
*Large and adjustable per group [quota](Storage_and_file_management/fr#Quotas_et_politiques.md). 
...
|-
| 1145 || rowspan="3"|64 || 250G or 256000M || rowspan="2"|2 x [AMD EPYC 7532 (Zen 2)](https://www.amd.com/en/support/downloads/drivers.html/processors/epyc/epyc-7002-series/amd-epyc-7532.html) @ 2.40 GHz, 256M cache L3 || rowspan="3"|1 x 960G SSD || rowspan="3"|
|-
...
From the [Narval portal](https://portail.narval.calculquebec.ca/), you can monitor your jobs using CPUs and GPUs <b>in real time</b> or examine jobs that have run in the past. This can help you to optimize resource usage and shorten wait time in the queue.
