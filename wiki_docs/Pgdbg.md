...
1. **Execution and debugging**: Execute the code and analyze the results
...
[thumbnail|300px|PGDGB in graphical mode(click for a larger image)|left](File:Pgdbg_gui_schematic.png.md)
...
[thumbnail|300px|Drop-Down Lists on Toolbar(click for a larger image)|left](File:Pgdbg-toolbar-drop-down-lists.png.md)
...
[thumbnail|300px|The source window contains a number of visual aids that allow you to know more about the execution of your code.(click for a larger image)|left](File:Pgdbg-source-win.png.md)
