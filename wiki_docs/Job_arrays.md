...
<i>Parent page: [Running jobs](Running_jobs.md)</i>
...
1. Place the code to execute here
pwd
ls
```
...
1. Run with: python my_script.py
```
...
1. Run with: python my_script_parallel.py $SLURM_ARRAY_TASK_ID
```
