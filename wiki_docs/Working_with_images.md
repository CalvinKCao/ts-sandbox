...
For a list of images provided by our staff, see [images](Cloud_resources#Images.md).
...
See [Creating an image from a volume](Working_with_volumes#Creating_an_image_from_a_volume.md).
...
1. A member of the second project must accept the newly shared image.
...
To accept the shared image a member in the second project uses the [OpenStack](OpenStack_Command_Line_Clients#Separate_Command-line_interfaces.md) command below.
<syntaxhighlight lang="console">
