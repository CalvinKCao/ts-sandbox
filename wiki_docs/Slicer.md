...
You can find information on how to connect with MobaXTerm and use X11 fowarding at [Connecting with MobaXTerm](Connecting_with_MobaXTerm.md).

#### Use an interactive node

Runtime is limited on the login nodes, so you should request an [interactive job](Running_jobs#Interactive_jobs.md) to have more time for exploring and visualizing your data. Additionally, by doing so, you will be able to use more cores for faster processing.
