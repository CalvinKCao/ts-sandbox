...
<code>https://object-arbutus.cloud.computecanada.ca/BUCKET_NAME/FILE_NAME.dat</code>
...
Instructions on [managing bucket policies](Arbutus_object_storage#Managing_data_container_(bucket)_policies_for_your_Arbutus_Object_Store.md) for your object store, including examples using s3cmd are available on the main [object storage](Arbutus_object_storage.md) page.