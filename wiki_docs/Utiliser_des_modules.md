...
The <code>spider</code> sub-command searches the complete tree of all modules in the current [standard software environment](Standard_software_environments.md) and displays it.
```bash
module spider
```
