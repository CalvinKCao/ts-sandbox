...
<i>Parent page: [Job scheduling policies](Job_scheduling_policies.md)</i>
...
Compute-related resources granted by core-year and GPU-year allocations require research groups to submit what are referred to as <i>jobs</i> to a <i>scheduler</i>. A job is a combination of a computer program (an application) and a list of resources that the application is expected to use. The [scheduler](What_is_a_scheduler?.md) is a program that calculates the priority of each job submitted and provides the needed resources based on the priority of each job and the available resources.
...
With the 2025 [infrastructure renewal](infrastructure_renewal.md), it will become possible to schedule a fraction of a GPU using [multi-instance GPU](Multi-Instance_GPU.md) technology.  Different jobs, potentially belonging to different users, can run on the same GPU at the same time.  Following [NVidia's terminology](https://docs.nvidia.com/datacenter/tesla/mig-user-guide/#terminology), a fraction of a GPU allocated to a single job is called a <i>GPU instance</i>, also sometimes called a <i>MIG instance</i>.  
...
[frame|Figure 1 - Core equivalent diagram.](File:Core_equivalent_diagram_GP.png.md)
...
[thumb|upright=1.1|center|Figure 4 - RGU equivalent diagram.](File:GPU_equivalent_diagram.png.md) <br clear=all>
...
[thumb|center|Figure 5 - Two RGU equivalents.](File:Two_GPU_equivalents.png.md) <br clear=all>
...
[thumb|center|Figure 6 - 1.66 RGU equivalents, based on cores.](File:GPU_and_a_half_(cores).png.md) <br clear=all>
...
[thumb|center|Figure 7 - 1.5 RGU equivalents, based on memory.](File:GPU_and_a_half_(memory).png.md) <br clear=all>
...
[thumb|upright=2.1|center|Figure 8 - 2.6 RGU equivalents, based on the V100-32gb GPU.](File:Two.Six_RGU_equivalents.png.md) <br clear=all>
...
[thumb|upright=2.66|center|Figure 9 - 4.0 RGU equivalents, based on the A100-40gb GPU.](File:Four_RGU_equivalents.png.md) <br clear=all>
...
|-
! | [Fir](Fir#Node_characteristics.md)
| 0.98
| 23.6
|-
! scope="row"| [Narval](Narval/en#Node_characteristics.md)
| 3.00
| 31.1
|-
! scope="row"| [Nibi](Nibi#Node_characteristics.md)
| 1.15
| 20.5
|-
! scope="row"| [Rorqual](Rorqual/en#Node_characteristics.md)
| 1.31
| 10.2
|-
! [Trillium](Trillium#Node_characteristics.md)
| 1.97
| 15.4
|}
...
|-
! rowspan="4"| [Fir](Fir#Node_characteristics.md)
| <b>H100-80gb</b>
| <b>12.2</b>
| <b>12 cores, 288 GB</b>
| <b>12 cores, 280 GB</b>
...
| 6 cores, 140 GB
|-
! rowspan="5"| [Narval](Narval/en#Node_characteristics.md)
| <b>A100-40gb</b>
| <b>4.0</b>
...
| 6 cores, 62 GB
|-
! rowspan="4"| [Nibi](Nibi#Node_characteristics.md)
| <b>H100-80gb</b>
| <b>12.2</b>
| <b>14 cores, 250 GB</b>
| <b>14 cores, 250 GB</b>
...
| 6 cores, 124 GB
|-
! rowspan="4"| [Rorqual](Rorqual/en#Node_characteristics.md)
| <b>H100-80gb</b>
| <b>12.2</b>
...
[thumb|alt=usage portal landing view|Usage portal landing view. (Click on the image for a larger version.)](File:Slurm_portal_land_edit.png.md)
...
[thumb|alt=target and queued use|Allocation target and queued resources displayed on usage figure](File:Slurm_portal_account_usage_queued_edit_2.png.md)
...
[thumb|alt=mouse hover|Additional figure options when hover the mouse over the figure window](File:Slurm_portal_hover_total_plotly_edit.png.md)
...
[thumb|alt=default raw usage|Display of default account usage, including SLURM Raw Shares and SLURM Raw Usage](File:Slurm_portal_def_rawusage.png.md)
...
[thumb|alt=Select a specific cluster and time interval|Select a specific cluster and time interval](File:Slurm_portal_select_sys_date.png.md)
...
[thumb|alt=usage extended duration|Display usage over an extended period into the future](File:Slurm_portal_account_use_duration_edit_2.png.md)
...
[thumb|alt=Parameters of the usage series histogram|Parameters of the usage series histogram](File:Slurm_portal_parameter_panel.png.md)
...
[thumb|alt=cumulative use|Display the running total of account usage](File:Slurm_portal_account_use_cumulative_edit_2.png.md)
...
[thumb|Navigation to <i>View Group Usage</i>](File:Select_view_group_usage_edit.png.md)
...
[thumb|CPU and GPU usage by compute resource](File:ccdb_view_use_by_compute_resource.png.md)
...
: <b>Storage usage</b> is discussed in [Storage and file management](Storage_and_file_management.md). 
<br clear=all>
...
[thumb|Usage by compute resource with monthly breakdown](File:Ccdb_view_use_by_compute_resource_monthly.png.md)
...
[thumb|Usage by Resource Allocation Project with monthly breakdown](File:Ccdb_view_use_by_compute_resource_monthly_proj_edit.png.md)
...
[thumb|alt=GPU usage|GPU usage summary with Reference GPU Unit (RGU) breakdown table.](File:Rgu_en.png.md)
...
## Usage by submitter
[thumb|CPU and GPU usage by submitter](File:Ccdb_view_use_by_submitter_summary_edit.png.md)
