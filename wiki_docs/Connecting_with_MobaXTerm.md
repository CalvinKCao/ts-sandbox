...
[600px|thumb| Creating an SSH session (Click for larger image)](File:MobaXterm_basic.png.md)
[600px|thumb| Connected to a remote host (Click for larger image)](File:MobaXterm_connected.png.md)
[600px|thumb| Enabling X11 Forwarding(Click for larger image)](File:MobaXterm_X11.png.md)
[600px|thumb| Specifying a private key (Click for larger image)](File:MobaXterm_ssh_key.png.md)
