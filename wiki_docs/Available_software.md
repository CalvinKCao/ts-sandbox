...
A current list of the software available on our national systems is below. This list changes frequently as new software is added. You can request the installation or updating of a particular program or library by contacting [technical support](technical_support.md). If you wish to use our software environment on your own system, please see [Accessing CVMFS](Accessing_CVMFS.md).

{{Warning
|title=Availability
|content=<b>Some software listed below may not be available in the specific StdEnv you have loaded.</b>

<code>StdEnv/2020</code> is now deprecated/hidden on the newer systems. See [StdEnv/2020](Standard_software_environments#StdEnv/2020.md)
}}

## Notes
Except for basic system programs, you access most software by loading a <b>module</b>. See [Using modules](Using_modules.md) for more on how to use the Lmod module system. Note that some prerequisite modules are loaded by default. 

Here are a few things to know about the available software:
- Most [Python](Python.md) modules are not installed as (Lmod) modules. They are instead provided as binary [wheels](Available_Python_wheels.md), stored on our systems under <code>/cvmfs/soft.computecanada.ca/custom/python/wheelhouse/</code>. One such package is [TensorFlow](TensorFlow.md). For instructions on how to install or list Python packages, see the [Python](Python.md) page. 
- Similarly, most [R](R.md) or [Perl](Perl.md) packages are not installed either. We recommend installing them in your personal or group file space. See the [R](R.md) and [Perl](Perl.md) pages for instructions on how to do so. 
- A page discusses [symbolic algebra software](symbolic_algebra_software.md) like Mathematica and Sage. 
- Note that [Docker](https://www.docker.com/) is not available on our clusters but [Apptainer](Apptainer.md) is available by loading the module <code>apptainer</code>. Docker containers can be converted to Apptainer as discussed [here](https://apptainer.org/docs/).  
...
- While the vast majority of the software packages below are accessible on all our servers, a few are only available at one site or another due to licensing restrictions. See [Site-specific software](Available_software#Site-specific_software.md) below.
...
|-
| adf/2016.106 ||rowspan="4"| chem ||rowspan="4"| [ADF](ADF.md) ||rowspan="4"| Nibi ||rowspan="4"| Amsterdam Density Functional Modeling Suite, computational chemistry software
|-
| adf/2017.207  
|-
| adf/2018.104    
...
| adf/2019.305 
|-
| ams/2020.102 || chem || [AMS](AMS.md) || Nibi ||  Amsterdam Modeling Suite products
|-
| amber/16 || chem || [AMBER](AMBER.md) || Nibi|| The Amber Molecular Dynamics Package
|-
...
| dirac/17.0  
|-
| galaxy/20.01 || bio || || Cedar || Galaxy is a scientific workflow, data integration, and data and analysis persistence and publishing platform that aims to make computational biology accessible to research scientists that do not have computer programming or systems administration experience. Any group on Cedar can have one Galaxy instance. The Galaxy instance will be run under a shared account which will be created by admins. Please contact [technical support](technical_support.md) to set up Galaxy for you. Homepage: https://usegalaxy.org/
|-
| gaussian/g03.d01 ||rowspan="4"| chem ||rowspan="4"| [Gaussian](Gaussian.md) ||rowspan="4"| Nibi ||rowspan="4"|  Gaussian is a general-purpose computational chemistry software package. Homepage: http://gaussian.com/  
|-
| gaussian/g09.e01   
|-
| gaussian/g16.b01  
...
| gaussian/g16.c01  
|-
| gaussian/g03.d01 ||rowspan="6"| chem ||rowspan="6"| [Gaussian](Gaussian.md) ||rowspan="6"| Fir ||rowspan="6"|  Gaussian is a general-purpose computational chemistry software package. Homepage: http://gaussian.com/
|-
| gaussian/g09.b01  
|-
| gaussian/g09.e01  
...
| gaussian/g16.c01  
|-
| gbrowse/2.56 || bio || [GBrowse](GBrowse.md) || Cedar || GBrowse is a combination of database and interactive web pages for manipulating and displaying annotations on genomes. Homepage: http://gmod.org/wiki/GBrowse
|-
