...
[thumb|OpenStack Horizon Dashboard GUI](File:Dashboard.png.md)
The [OpenStack command line clients](OpenStack_command_line_clients.md) allows you to perform functionality which the dashboard does not.
...
See the [[OpenStack End User documetation](https://docs.openstack.org/horizon/latest/user|The) for more details on how to use the dashboard GUI.