...
[Category:Pages with video links](Category:Pages_with_video_links.md)
= Introduction =
...
As this is a GUI application, log in using <code>ssh -Y</code>, and use an [SSH client](SSH.md) like [MobaXTerm](Connecting_with_MobaXTerm.md) (Windows) or [XQuartz](https://www.xquartz.org/) (Mac) to ensure proper X11 tunnelling.
...
[400px|thumb|right|DDT on **gra-vdi.computecanada.ca**](File:DDT-VNC-1.png.md)
[400px|thumb|right|Program on **graham.computecanada.ca**](File:DDT-VNC-2.png.md)
...
After you are done using DDT, you can if you like restore permissions to what they were (assuming you recorded them).  More information on how to do this can be found on page [Sharing_data](Sharing_data.md).

= See also =
- ["Debugging your code with DDT"](https://youtu.be/Q8HwLg22BpY), video, 55 minutes.
- [A short DDT tutorial.](Parallel_Debugging_with_DDT.md)