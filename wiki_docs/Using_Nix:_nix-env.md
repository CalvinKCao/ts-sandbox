...
This page details using the legacy <code>nix-env</code> command to manage a per-user environment. For an overview of Nix, start with our [using nix page](Using_Nix.md).
