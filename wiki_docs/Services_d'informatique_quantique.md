...
See [Getting started with MonarQ](MonarQ/en#Getting_started.md).
...
- [PennyLane](PennyLane.md), Python library
- [Snowflurry](Snowflurry.md), Julia library
- [Qiskit](Qiskit/fr.md), Python library
...
<span id="Aide_à_la_recherche_et_soutien_technique"></span>
...
If you have questions on our quantum computing services, write to [mailto:quantique@calculquebec.ca quantique@calculquebec.ca].