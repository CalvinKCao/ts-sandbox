...
If you have suggestions, please write to [technical support](technical_support.md).}}
...
### Log into the Ubuntu VM and create a <i>custom_ssh</i> folder
```
...
### Customize <i>.ssh/config</i> on Ubuntu
```
...
[File:MobaXterm-setup.jpg](File:MobaXterm-setup.jpg.md)

[File:MobaXterm-VSL-localdriveC.jpg](File:MobaXterm-VSL-localdriveC.jpg.md)
<!--
