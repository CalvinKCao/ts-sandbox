...
[600px|thumb|center| Cloud shared security responsibility model (Click for larger image)](File:Cloud_shared_security_responsibility_model.png.md)
...
- [applying updates](Security_considerations_when_running_a_VM#Updating_your_VM.md) and security patches on a timely basis; 
