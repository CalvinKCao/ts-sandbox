...
Principal Investigators must be granted an AIP-type RAP (prefix <code>aip-</code> ) by their AI Institution,
...
- Each /home directory has a small fixed [quota](Storage_and_file_management#Filesystem_quotas_and_policies.md).
...
- Inactive data will be [purged](Scratch_purging_policy.md).
|-
|<b>Project space</b>||
- Large adjustable [quota](Storage_and_file_management#Filesystem_quotas_and_policies.md) per project.
- Has daily backup.
|}
