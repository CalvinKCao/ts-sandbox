...
- [Nibi Open OnDemand Quickstart](Nibi#Access_through_Open_OnDemand_(OOD).md)

=Logging into the Open OnDemand portal=

[thumb|right|600px|Figure 1: Example of Trillium dashboard.](Image:ood-dashboard.png.md)
...
[thumb|right|600px|Figure 2: Example of Trillium file browser.](Image:ood-file-browser.png.md)
...
The current file size upload limit is 10GB; if you need to upload a file larger than this or are facing upload issues due to a bad internet connection for example, please try using [Globus](Globus.md). There is a Globus button in the file browser at the top right, [300px](File:Globus_button.png.md), which will take you to the Globus web interface where you can log in with your Alliance username and password. The path navigated to in the Open OnDemand file browser will be the same path opened in Globus.

=Job submission=

[thumb|right|600px|Figure 3: Example of Trillium Job Composer.](Image:ood-job-composer.png.md)
...
[thumb|center|600px|Figure 4: Example of Trillium Active Jobs.](Image:ood-active-jobs.png.md)
...
| <div style="text-align: center;">
    ...
    <br>Figure 5: Interactive app submission form.
  </div>
| <div style="text-align: center;">
    [600px](Image:ood_session_tab.png.md)
    <br>Figure 6: Interactive sessions page.
    [600px](Image:jupyter-session.png.md)
    <br>Figure 7: Interactive app session.
  </div>
|}
</div>
...
[thumb|right|600px|Figure 7: Example of Trillium Terminal](Image:ood-terminal.png.md)
...
[thumb|right|600px|Figure 8: Accessing error logs via the session card](Image:ood-session-id.png.md)
