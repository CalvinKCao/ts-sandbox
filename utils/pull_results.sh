...
RSYNC_OPTS=(
    ...
    --include='*_joint_finetuned*.pt'
    --include='*_joint_ft_hp*.json'
    --include='joint_pretrained*.pt'
    --include='joint_pretrain_hp*.json'
    --include='pretrained_dim*/joint_pretrained*.pt'
    --include='pretrained_dim*/joint_pretrain_hp*.json'
    --include='*.log'
    --exclude='archive/'
    --exclude='*'
)
