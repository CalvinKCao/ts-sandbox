...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| ETTh1 | ETTh1 | 0.4059 | 0.3060 | 3951193 | 0.3974 | 0.3021 | 3951527 | 0.4117 | 0.3114 | policy (not tuned) | 3943934 | 0.3762 | 0.2985 | 3951201 | **MMPD (subset)** |
| ETTh2 | ETTh2 | 0.3199 | 0.2705 | 3951194 | 0.3116 | 0.2673 | 3951528 | — | — | — | — | 0.3186 | 0.2705 | 3951202 | **Flat subsets EMA0.99** |
| exchange_rate | exchange_rate | 0.0880 | 0.1660 | 3951195 | 0.0893 | 0.1684 | 3951529 | 0.0871 | 0.1685 | policy (not tuned) | 3943935 | 0.0810 | 0.1563 | 3951203 | **MMPD (subset)** |
| weather | weather_4v_s2 | 0.0978 | 0.1776 | 3951196 | 0.0971 | 0.1758 | 3951530 | 0.0987 | 0.1775 | policy (not tuned) | 3943937 | 0.1128 | 0.1911 | 3951204 | **Flat subsets EMA0.99** |
...
|---|---|---|---|---|---|---|---|
| ETTh1 | ETTh1 | policy (not tuned) | 0.4117 | 0.4158 | 0.3114 | 0.4058 | 3943934 |
| ETTm1 | ETTm1_4v_s3 | policy (not tuned) | 0.4784 | 0.4232 | 0.3374 | 0.4835 | 3943936 |
| exchange_rate | exchange_rate | policy (not tuned) | 0.0871 | 0.2067 | 0.1685 | 0.0884 | 3943935 |
| weather | weather_4v_s2 | policy (not tuned) | 0.0987 | 0.2185 | 0.1775 | 0.0978 | 3943937 |
