...
| 2 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_400` | -4.33 | +7 | — | — | -5 | -15 | — | — | — | **OK** |
...
| 7 | **Flat subsets EMA0.98** | -0.67 | +8 | — | — | -1 | -9 | — | — | — | **OK** |
| 8 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_150` | -0.67 | -4 | — | — | +18 | -16 | — | — | — | **OK** |
| 9 | `sweep_baseline` | +0.00 | 0 | — | 0 | 0 | 0 | — | — | — | **OK** |
| 10 | `hp_beta_end_04` | +0.00 | +9 | — | +8 | -10 | -7 | — | — | — | **OK** |
| 11 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_200` | +0.33 | -3 | — | — | +22 | -18 | — | — | — | **OK** |
| 12 | `hp_cfg_dropout_02` | +1.00 | +3 | — | +3 | -7 | +5 | — | — | — | **OK** |
...
| 20 | `hp_anchor_lambda_090` | +5.75 | +22 | — | -4 | -11 | +16 | — | — | — | **OK** |
| 21 | `hp_ctxbias_neg01` | +5.75 | +14 | — | +4 | -8 | +13 | — | — | — | **OK** |
...
| 33 | `hp_dit_dropout_01` | +12.50 | -7 | — | +9 | +28 | +20 | — | — | — | **OK** |
| 34 | `hp_ctxbias_005` | +12.50 | +30 | — | -1 | +11 | +10 | — | — | — | **OK** |
...
| 44 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_800` | +27.00 | +31 | — | — | +33 | +17 | — | — | — | **OK** |
...
| 8 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_150` | 0.4046 | 0.4107 | 0.3069 | -4 | **OK** |
| 9 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_200` | 0.4049 | 0.4141 | 0.3091 | -3 | **OK** |
...
| 19 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_400` | 0.4081 | 0.4169 | 0.3110 | +7 | **OK** |
...
| 43 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_800` | 0.4506 | 0.4376 | 0.3281 | +31 | **OK** |
...
| Rank | Config | anchor_mse | anchor_mae | crps | Δrank | Status |
|---|---|---|---|---|---|---|
| 1 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_200` | 0.3011 | 0.3397 | 0.2685 | — | **OK** |
| 2 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_150` | 0.3016 | 0.3395 | 0.2678 | — | **OK** |
| 3 | **Flat subsets accum1.5x LR-hi** | 0.3017 | 0.3394 | 0.2631 | — | **OK** |
| 4 | **Flat subsets accum2.0x LR-hi** | 0.3029 | 0.3423 | 0.2656 | — | **OK** |
| 5 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_400` | 0.3076 | 0.3538 | 0.2801 | — | **OK** |
...
| 11 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_800` | 0.3148 | 0.3619 | 0.2941 | — | **OK** |
...
| 8 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_400` | 0.0873 | 0.2072 | 0.1690 | -5 | **OK** |
...
| 31 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_150` | 0.0904 | 0.2118 | 0.1716 | +18 | **OK** |
...
| 35 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_200` | 0.0910 | 0.2111 | 0.1722 | +22 | **OK** |
...
| 46 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_800` | 0.1054 | 0.2328 | 0.1704 | +33 | **OK** |
...
| Rank | Config | anchor_mse | anchor_mae | crps | Δrank | Status |
|---|---|---|---|---|---|---|
| 1 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_200` | 0.0938 | 0.2172 | 0.1730 | -18 | **OK** |
| 2 | **Flat subsets EMA0.999** | 0.0945 | 0.2193 | 0.1759 | -17 | **OK** |
| 3 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_150` | 0.0945 | 0.2176 | 0.1740 | -16 | **OK** |
| 4 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_400` | 0.0959 | 0.2195 | 0.1756 | -15 | **OK** |
...
| 36 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_800` | 0.1007 | 0.2260 | 0.1879 | +17 | **OK** |
...
| 5 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_200` | 0.1671 | 0.2038 | 0.1537 | — | **OK** |
| 6 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_150` | 0.1678 | 0.2023 | 0.1537 | — | **OK** |
...
| 15 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_400` | 0.1742 | 0.2123 | 0.1595 | — | **OK** |
...
| 21 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_800` | 0.2156 | 0.2554 | 0.1873 | — | **OK** |
...
| 8 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_150` | 0.4845 | 0.2948 | 0.2244 | — | **OK** |
| 9 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_200` | 0.5007 | 0.3052 | 0.2312 | — | **OK** |
...
| 18 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_400` | 0.5417 | 0.3336 | 0.2605 | — | **OK** |
...
| 23 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_800` | 0.7107 | 0.4152 | 0.3299 | — | **OK** |
...
| 10 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_200` | 0.2132 | 0.2367 | 0.1879 | — | **OK** |
| 11 | **Flat subsets EMA0.95** | 0.2136 | 0.2379 | 0.1881 | — | **OK** |
| 12 | **Flat subsets accum2.0x LR-lo** | 0.2136 | 0.2398 | 0.1933 | — | **OK** |
| 13 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_150` | 0.2144 | 0.2347 | 0.1890 | — | **OK** |
| 14 | **Flat subsets EMA0.90** | 0.2147 | 0.2387 | 0.1884 | — | **OK** |
| 15 | **Flat subsets accum2.0x** | 0.2158 | 0.2394 | 0.1876 | — | **OK** |
| 16 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_400` | 0.2169 | 0.2415 | 0.1924 | — | **OK** |
...
| 20 | `binary_anchor_stationary_flat_subsets_grad_accum_guidance_800` | 0.2246 | 0.2498 | 0.2010 | — | **OK** |
