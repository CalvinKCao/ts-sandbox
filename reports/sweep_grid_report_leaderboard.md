...
| 2 | `hp_lr_cosine_warmup2` | -2.00 | -2 | — | -2 | -2 | -2 | — | — | — | **pre-fix invalid** |
| 3 | `hp_lr_cosine_warmup5` | -1.00 | -1 | — | -1 | -1 | -1 | — | — | — | **pre-fix invalid** |
| 4 | **Flat subsets EMA0.99** | -0.33 | -4 | — | — | +6 | -3 | — | — | — | **OK** |
| 5 | `hp_beta_end_04` | +0.00 | +4 | — | +7 | -6 | -5 | — | — | — | **OK** |
| 6 | `sweep_baseline` | +0.00 | 0 | — | 0 | 0 | 0 | — | — | — | **OK** |
...
| 11 | **MS tune** | +2.75 | +7 | — | +3 | -3 | +4 | — | — | — | **pre-fix invalid** |
| 12 | `hp_anchor_lambda_095` | +2.75 | +8 | — | -7 | +2 | +8 | — | — | — | **OK** |
...
| 5 | `hp_lr_cosine_warmup2` | 0.4059 | 0.4085 | 0.3060 | -2 | **pre-fix invalid** |
| 6 | `hp_lr_cosine_warmup5` | 0.4059 | 0.4085 | 0.3060 | -1 | **pre-fix invalid** |
...
| 14 | **MS tune** | 0.4117 | 0.4158 | 0.3114 | +7 | **pre-fix invalid** |
...
| 6 | **MS tune** | 0.0871 | 0.2067 | 0.1685 | -3 | **pre-fix invalid** |
| 7 | `hp_lr_cosine_warmup2` | 0.0880 | 0.2078 | 0.1660 | -2 | **pre-fix invalid** |
| 8 | `hp_lr_cosine_warmup5` | 0.0880 | 0.2078 | 0.1660 | -1 | **pre-fix invalid** |
...
| 6 | `hp_lr_cosine_warmup2` | 0.0978 | 0.2224 | 0.1776 | -2 | **pre-fix invalid** |
| 7 | `hp_lr_cosine_warmup5` | 0.0978 | 0.2224 | 0.1776 | -1 | **pre-fix invalid** |
...
| 12 | **MS tune** | 0.0987 | 0.2185 | 0.1775 | +4 | **pre-fix invalid** |
