"""
iTransformer and patch-decoder guidance for binary DiT cross-attention.

Frozen encoder tokens (not a 2D ghost channel) condition FactorizedDiT at the
bottleneck. Patch-decoder tokens are mixed to context_dim and skip the
iTransformer adapter.
"""
