...
def create_diffusion_model(
    ...
    **overrides: Any,
    ...
    config = DiffusionTSFConfig(
        ...
        use_linear_attn=bool(o("use_linear_attn", state.use_linear_attn)),
        use_linear_cross_attn=bool(o("use_linear_cross_attn", state.use_linear_cross_attn)),
        use_attn_res=bool(o("use_attn_res", state.use_attn_res)),
