"""
Tests for train_multivariate_pipeline (subset generation, manifest, registry).

Run with: pytest models/diffusion_tsf/tests/test_multivariate_pipeline.py -v
"""
...
class TestVariateSubsetGeneration:
    ...
    def test_seven_variate_dataset_returns_single_subset(self):
