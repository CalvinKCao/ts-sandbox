...
# Try to import DILATE-enabled experiment class, fall back to standard if not available
try:
    sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
    from train_etth2 import Exp_Main_With_Dilate as Exp_Main
    print("Using DILATE-enabled experiment class")
except ImportError:
    from exp.exp_main import Exp_Main
    print("Warning: DILATE loss not available, using standard experiment class")
